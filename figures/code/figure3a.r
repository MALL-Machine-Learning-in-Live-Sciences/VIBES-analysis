...
library(grDevices)
lista.betas <- readRDS(file = '~/git/BV_Microbiome/figures/data/betas.rds')
taxonomia <- readRDS(file = '~/git/BV_Microbiome/figures/data/tax_table.rds')
...
svg(paste0('figures/plots/fig3/circos_cluster_',i,'.svg'),
     width = 12, 
     height = 12,
     pointsize = 7)
circos.clear()
