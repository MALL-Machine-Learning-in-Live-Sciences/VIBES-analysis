...
#Ravel
library(readxl)
TaxonomyTableRavel <- read_excel("extdata/Ravel/TaxonomyTableRavel.xlsx")
...
otu = read.delim2(paste0("extdata/Ravel/Ravel_otutable.txt"), header = T, sep = '\t')
clin = read.delim2(paste0("extdata/Ravel/Ravel_Metadata.txt"), header = T, sep = '\t')
...
#Srinivasan
TaxonomyTableSriniv <- read_excel("extdata/Sriniv/TaxonomyTableSriniv.xlsx")
...
otu2 = read.delim2(paste0("extdata/Sriniv/Srinivasan_otutable.txt"), header = T, sep = '\t')
clin2 = read.delim2(paste0("extdata/Sriniv/Sriniv_Metadata.txt"), header = T, sep = '\t')
...
saveRDS(Ravel_phyloseq, file = "../data/pseqs/Ravel_pseq.rds")
saveRDS(Sriniv_phyloseq, file = "../data/pseqs/Sriniv_pseq.rds")