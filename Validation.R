...
features = get.features(bench = BMR.C, algoritmo = "classif.xgboost.tuned", indice = 2)
...
data = readRDS("projects/Entropy/data/train/Ravel_Genus_C_train_FCBF_8.rds")
...
saveRDS(CM, "projects/Entropy/data/validation/CM_Validation/CM_xGBOOST_FCBF.rds")
